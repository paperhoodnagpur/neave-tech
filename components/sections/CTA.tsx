      ...
      <div className="container-narrow relative">
        <div className="relative rounded-[36px] overflow-hidden p-10 sm:p-14 lg:p-20 border border-brand/20 bg-surface text-ink">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle at 1px 1px, rgba(14,138,79,0.2) 1px, transparent 0)",
          ...
          <div
            aria-hidden
            className="pointer-events-none absolute -right-24 -top-24 w-[420px] h-[420px] rounded-full border border-brand/15 opacity-60"
          />
          <div
            aria-hidden
            className="pointer-events-none absolute -right-12 -top-12 w-[280px] h-[280px] rounded-full border border-brand/20 opacity-50"
          />
          ...
          <div className="relative grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="flex flex-col items-start gap-7">
              ...
              <RevealText
                as="h2"
                by="word"
                className="h-display text-[clamp(1.95rem,3.6vw,3.2rem)] text-ink leading-[1.05]"
              >
                Ready to Build Your Digital Infrastructure?
              </RevealText>
              <p className="text-muted text-lg leading-relaxed">
                Tell us what you're operating, where it's bottlenecking, and
                where it has to be in two years. We'll come back with an
                architecture and a delivery plan — not a pitch.
              </p>
              <div className="pt-3 flex flex-wrap gap-4">
                <MagneticButton href="mailto:mail@neave.tech" variant="primary">
